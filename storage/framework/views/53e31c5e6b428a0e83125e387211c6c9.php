...
<head>
	...
	<link href="<?php echo e(asset('css/WelcomePageStyles.css')); ?>" rel='stylesheet'/>
</head>
<body>
	<header class='header'>
		...
		<nav class="navbar">
			...
			<a href="###" style="--i:2;">Support</a>
			<a href="###" style="--i:3;">Learn More</a>
		</nav>
		...
		<section class= "home">
			<div class="home-content">
				...
				<a href="#" class="button">Food Seller Login</a>
			</div>
...
</html><?php /**PATH D:\BRACU\Current Semester\CSE470\Project\ShareAndCare\resources\views/WelcomePage.blade.php ENDPATH**/ ?>