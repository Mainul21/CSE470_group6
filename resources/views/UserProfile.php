                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <p type="text" class="form-control mb-1" ><?php echo $result["username"]?></p>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Name</label>
                                    <p type="text" class="form-control"><?php echo $result["name"]?></p>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">E-mail</label>
                                    <p type="text" class="form-control mb-1" ><?php echo $result["email"]?></p>                                   
                                </div> 
                                <div class="form-group">
                                    <label class="form-label">Address</Address></label>
                                    <p type="text" class="form-control"><?php echo $result["address"]?>a</p>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Phone</label>
                                    <p type="text" class="form-control"><?php echo $result["phone"]?></p>
                                </div>  
