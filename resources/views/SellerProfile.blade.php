...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/SellerProfileStyles') }}">
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            <div class="card-body media align-items-center">
                                ...
                                <div class="media-body ml-4">
                                    ...
                                    <button type="button"><a href="CreatePost.blade.php"> Creat Post </a></button>
                                        <button type="button"><a href="SellerHomePage.blade.php"> Home </a></button>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <p type="text" class="form-control mb-1" ></p>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="pending-order">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p type="Number" class="form-control">5</p>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="completed-order">
                                <div class="card-body">
                                    ...
                                    <div class="button">
                                        <button type="button"><a href="CompletedOrders.blade.html"> Completed Orders Info </a></button>
                                    </div>
                                    </div>                                       
                                </div>                 
                            </div>                                                                                     
